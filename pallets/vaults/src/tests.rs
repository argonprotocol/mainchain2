...
fn it_can_distribute_a_bid_pool() {
	new_test_ext().execute_with(|| {
		...
		// it's 100 argons allocated to the pool
		assert_eq!(
			Balances::free_balance(1),
			198_000_000_000u128 + 66_666_666u128 + 1u128 /* the remainder goes to the
			                                              * biggest prorata */
		);
		assert_eq!(Balances::free_balance(2), 496_000_000_000u128 + 33_333_333u128);
